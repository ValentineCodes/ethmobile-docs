...
This website contains ETH Mobile Documentation and is built using [Docusaurus 2](https://docusaurus.io/).
...
Clone the repository, install dependencies, and start Docusaurus:

```
git clone https://github.com/dewdrip/eth-mobile-docs.git
cd eth-mobile-docs
yarn install
yarn start
```
...
If you change the [search configuration](docusaurus.config.ts), run `yarn build` and `yarn serve` again so search indexes refresh.
...
When **adding a new page**, you need to fork the repository, create a new branch, and make all changes necessary in your repository. Once you are done with your changes, create a PR to ETH Mobile Documentation repository.
...
Fork the repository, create a new branch, and make all changes necessary in your repository. Once you are done with your changes, create a PR to ETH Mobile Documentation repository.

### Configuration

- `docusaurus.config.ts` - This file contains the Docusaurus configuration. Here you can manage site metadata, links in the header and footer, and theme configuration. You can visit [Docusaurus docs](https://docusaurus.io/docs/configuration) to learn more about the Docusaurus settings.

### Sidebars

- `sidebars.ts` - This specifies the sidebars for your documentation. You'll see that we currently have `type: 'autogenerated'` configured for the sidebar. This will generate sidebar menu links based on the folder structure and positions defined in each document.
