...
### 1. Your device/simulator and computer must be connected to the same Wi‑Fi.

> **Note:** Run `yarn configure-network` again whenever your Wi‑Fi or local IP changes. To run on a **physical device**, the device must be on the **same network** as your computer.
